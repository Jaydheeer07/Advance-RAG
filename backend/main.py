# main.py
from components.document_store import initialize_document_store
from components.ingestion import create_ingestion_pipeline
from components.retrieval import create_retrieval_pipeline
